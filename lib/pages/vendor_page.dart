...
class _VendorScreenState extends State<VendorScreen> {
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        itemBuilder: (context, index) {
          ...
          List<Widget> keywordChips = product['keywords'].map<Widget>((keyword) {
            return Container(
              ...
              child: Text(keyword, style: TextStyle(color: Colors.black45)),
            );
          }).toList();
      ...
      body: _isLoading
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              contentPadding: EdgeInsets.all(10),
              title: Text(order['productTitle'], style: TextStyle(fontWeight: FontWeight.bold)),
              subtitle: Text(
              ...
              trailing: ElevatedButton(
                onPressed: isCompleted ? null : () => _completeOrder(order['orderId'], index),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Try'nBuy", style: TextStyle(color: Colors.orangeAccent),),
