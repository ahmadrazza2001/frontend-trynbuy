...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void addToCart(String productId, String productName, String price, String imageUrl) {
    setState(() {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text('New Arrivals', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
        ),
        Container(
          height: 330,
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 5),
            Text(productName, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
            ...
            ElevatedButton.icon(
              onPressed: () => addToCart(productId, productName, price, imageUrl),
  ...
  Widget _cartContent() {
    if (_cart.isEmpty) {
      return Center(
        child: Text("Your cart is empty :(", style: TextStyle(color: Colors.white, fontSize: 15)),
      );
    } else {
      List<Widget> cartList = _cart.keys.map((key) {
        return Padding(
          ...
          child: Card(
            ...
            child: ListTile(
              leading: Image.network(_cart[key]['imageUrl'], width: 50, height: 50),
              title: Text(_cart[key]['name'], style: TextStyle(color: Colors.white, fontSize: 12)),
              subtitle: Text('PKR ${_cart[key]['totalPrice'].toStringAsFixed(2)}', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
              trailing: Row(
                ...
                children: [
                    ...
                    onPressed: () {
                      if (_cart[key]['quantity'] > 1) {
                        setState(() {
                          ...
                          _cart[key]['totalPrice'] = _cart[key]['basePrice'] * _cart[key]['quantity'];
                        });
                      } else {
                        _removeFromCart(key);
                      }
                  ...
                  Text('${_cart[key]['quantity']}', style: TextStyle(color: Colors.white, fontSize: 16)),
                  IconButton(
